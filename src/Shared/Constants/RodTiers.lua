...
local RodTiers = {
	...
	-- ============================================================
	-- Tier 4: Abyssal Rod — 7,500 Coins (FUTURE — gated behind Depth 100m)
	-- ============================================================
	{
		Name = "Abyssal Rod",
		Key = "AbyssalRod",
		...
		LuckBonus = 0.15,        -- +15%
		HookWindow = 0.25,       -- 25%
		UnlockCondition = "Reach Depth 100m (The Kelp Forest)",
		UnlockRequirement = {
			Type = "DepthReached",
			Depth = 100,
		},
		Description = "Forged in the crushing depths. Built for the abyss.",
		IsFuture = true,
	},
