...
-- ============================================================
{
    ...
    -- Phase 3 surface species
    {Name="Silver Skipjack",Key="SilverSkipjack",Zone="Surface",Rarity="Common",SpawnRate=0.3,BaseSellPrice={Min=20,Max=45},WeightRange={Min=1,Max=4},Behavior="Surface",Temperament="Wild",IdleSpeed=2,PatrolSpeed=5,FleeSpeed=14,AwarenessRadius=20,BobberInterestRadius=8,BiteDelayMin=1,BiteDelayMax=4,HookWindowSize=0.35,ReelDifficulty="Surface",TensionBuildRate=0.6,TugCount={Min=1,Max=4},TugStrength=.2,Schooling=true},
    {Name="Blue Sardine",Key="BlueSardine",Zone="Surface",Rarity="Common",SpawnRate=0.25,BaseSellPrice={Min=10,Max=25},WeightRange={Min=0.2,Max=1.2},Behavior="Surface",Temperament="Wild",IdleSpeed=1,PatrolSpeed=2,FleeSpeed=8,AwarenessRadius=5,BobberInterestRadius=8,BiteDelayMin=1,BiteDelayMax=4,HookWindowSize=0.4,ReelDifficulty="Surface",TensionBuildRate=0.4,TugCount={Min=1,Max=4},TugStrength=.2,Schooling=true},
    {Name="Flying Fish",Key="FlyingFish",Zone="Surface",Rarity="Uncommon",SpawnRate=0.18,BaseSellPrice={Min=60,Max=130},WeightRange={Min=0.5,Max=2},Behavior="Surface",Temperament="Wild",IdleSpeed=0,PatrolSpeed=12,FleeSpeed=20,AwarenessRadius=15,BobberInterestRadius=8,BiteDelayMin=1,BiteDelayMax=4,HookWindowSize=0.25,ReelDifficulty="Surface",TensionBuildRate=0.8,TugCount={Min=1,Max=4},TugStrength=.2,Schooling=false},
    {Name="Bonito",Key="Bonito",Zone="Surface",Rarity="Uncommon",SpawnRate=0.12,BaseSellPrice={Min=100,Max=220},WeightRange={Min=2,Max=6},Behavior="Surface",Temperament="Wild",IdleSpeed=4,PatrolSpeed=6,FleeSpeed=10,AwarenessRadius=15,BobberInterestRadius=8,BiteDelayMin=1,BiteDelayMax=4,HookWindowSize=0.28,ReelDifficulty="Surface",TensionBuildRate=1,TugCount={Min=1,Max=4},TugStrength=.2,Schooling=false},
    {Name="Mahi-Mahi",Key="MahiMahi",Zone="Surface",Rarity="Rare",SpawnRate=0.08,BaseSellPrice={Min=300,Max=700},WeightRange={Min=3,Max=10},Behavior="Surface",Temperament="Wild",IdleSpeed=3,PatrolSpeed=8,FleeSpeed=12,AwarenessRadius=15,BobberInterestRadius=8,BiteDelayMin=1,BiteDelayMax=4,HookWindowSize=0.22,ReelDifficulty="Surface",TensionBuildRate=1.2,TugCount={Min=1,Max=4},TugStrength=.2,Schooling=false},
    {Name="Sailfish",Key="Sailfish",Zone="Surface",Rarity="Rare",SpawnRate=0.05,BaseSellPrice={Min=800,Max=1800},WeightRange={Min=15,Max=40},Behavior="Surface",Temperament="Wild",IdleSpeed=8,PatrolSpeed=10,FleeSpeed=18,AwarenessRadius=30,BobberInterestRadius=8,BiteDelayMin=1,BiteDelayMax=4,HookWindowSize=0.18,ReelDifficulty="Surface",TensionBuildRate=1.5,TugCount={Min=1,Max=4},TugStrength=.2,Schooling=false},
    {Name="Moonfish",Key="Moonfish",Zone="Surface",Rarity="Legendary",SpawnRate=0.015,BaseSellPrice={Min=1500,Max=3000},WeightRange={Min=20,Max=50},Behavior="Surface",Temperament="Wild",IdleSpeed=3,PatrolSpeed=3,FleeSpeed=0,AwarenessRadius=25,BobberInterestRadius=8,BiteDelayMin=1,BiteDelayMax=4,HookWindowSize=0.1,ReelDifficulty="Surface",TensionBuildRate=1.7,TugCount={Min=1,Max=4},TugStrength=.2,Schooling=false},
    {Name="Storm Marlin",Key="StormMarlin",Zone="Surface",Rarity="Legendary",SpawnRate=0.005,BaseSellPrice={Min=3000,Max=6000},WeightRange={Min=40,Max=90},Behavior="Surface",Temperament="Wild",IdleSpeed=10,PatrolSpeed=14,FleeSpeed=20,AwarenessRadius=40,BobberInterestRadius=8,BiteDelayMin=1,BiteDelayMax=4,HookWindowSize=0.08,ReelDifficulty="Surface",TensionBuildRate=2,TugCount={Min=1,Max=4},TugStrength=.2,Schooling=false},
